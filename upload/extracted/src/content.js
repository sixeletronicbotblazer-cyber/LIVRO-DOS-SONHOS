export const content = {
  ...
  headline: 'Sonhou? Vá direto ao significado, ao bicho e aos números.',
  subheadline: 'Ficou com um sonho na cabeça? Abra o índice, encontre o verbete e veja em um só lugar a interpretação e as associações registradas no Livro dos Sonhos.',
  bullets: [
    'Ache o que sonhou pelo índice de A a Z.',
    'Leia a interpretação direto no verbete.',
    'Veja bicho e números associados quando indicados.'
  ],
  facts: ['120 páginas A4', 'Índice alfabético', 'Tabela dos 25 bichos', 'Leia no celular'],
  gallery: [
  ...
  steps: [
    ...
    ['03', 'Veja as associações', 'Leia a interpretação e consulte os números que aparecem abaixo dela.']
  ],
  included: [
  ...
  faqs: [
    ...
    ['Posso ler no celular?', 'Sim. Você pode abrir o arquivo em um leitor de PDF no celular e ampliar as páginas para ler.'],
